<template>
    ...
    <div v-if="lang == 'en'">
        <div class="reborn-botton">
        	...
        	<input type="text" placeholder="secret characters" v-model="password">
...
module.exports = {
    ...
    methods: {
        ...
        reborn() {
            ...
            var result = this.data[38]
            if (this.password == "love babe" && this.times == 0){
                result = this.data[38]
                console.log(result)
            }
            else{
            ...
            result = this.data[this.percentArray[rand]]
            console.log(result)
            }
